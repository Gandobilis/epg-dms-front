...
const { sheet, _currentPage, _totalPages, _totalElements, _pageSize, recordId, details, fetchSheetData, filter, clearFilter } = useSheet()
...
<template>
  ...
  <dialog id="my_modal_1" class="modal">
    ...
    <pagination v-model:current-page="_currentPage"
              v-model:page-size="_pageSize" v-model:total-pages="_totalPages" v-model:total-elements="_totalElements" />
  </dialog>
</template>
